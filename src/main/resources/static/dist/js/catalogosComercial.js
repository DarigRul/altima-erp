            ...
            if (rolAdmin == 1) {
                ...
                for (i in data) {
                    ...
                    a = [
                        ...
                        "<td style='text-align: center'>" +
                        "<button class='btn btn-info btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-html='true' data-content='<strong>Creado por: </strong>" + data[i][7] + " <br /><strong>Fecha de creación:</strong> " + data[i][9] + "<br><strong>Modificado por:</strong>" + creacion + "<br><strong>Fecha de modicación:</strong>" + data[i][10] + "'><i class='fas fa-info'></i></button> " +
                        (rolEditar == 1 ? "<button onclick='editarAgente(" + data[i][0] + ")' class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button>" : " ") +
                        (data[i][11] == 1 && rolEliminar == 1 ? "<button onclick='bajarAgente(" + data[i][0] + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-caret-down'></i></button>" : " ") +
                        (data[i][11] == 0 && rolEliminar == 1 ? "<button onclick='altaAgente(" + data[i][0] + ")' class='btn btn-success btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de alta'><i class='fas fa-caret-up'></i></button>" : " ") +
                        "</td>" +
                        "<tr>"
                    ];
                    b.push(a);
