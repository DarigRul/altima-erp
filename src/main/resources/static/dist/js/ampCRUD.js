            ...
            if (rolAdmin == 1) {
                ...
                for (i in data) {
                    ...
                    a = [
                        ...
                        "<td style='text-align: center;'>" +
                        "<button class='btn btn-info btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-html='true' data-content='<strong>Creado por: </strong>" + data[i][8] + " <br /><strong>Fecha de creación:</strong> " + data[i][9] + "<br><strong>Modificado por:</strong>" + data[i][10] + "<br><strong>Fecha de modicación:</strong>" + data[i][11] + "'><i class='fas fa-info'></i></button> " +
                        (rolEditar == 1 ? "<button onclick='editarAlmacenLogico(\"" + idlogico + "\",\"" + logico + "\",\"" + idfisico + "\",\"" + fisico + "\",\"" + idsalida + "\",\"" + salida + "\",\"" + identrada + "\",\"" + entrada + "\");'  class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button> " : " ") +
                        (data[i][12] == 1 && rolEliminar == 1 ? "<button onclick='bajaAlmacenLogico(" + idlogico + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-caret-down'></i></button>" : " ") +
                        (data[i][12] == 0 && rolEliminar == 1 ? "<button onclick='altaAlmacenLogico(" + idlogico + ")' class='btn btn-success btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Reactivar'><i class='fas fa-sort-up'></i></button>" : " ") +
            ...
            if (rolAdmin == 1) {
                ...
                for (i in data) {
                    ...
                    a = [
                        ...
                        "<td style='text-align: center;'>" +
                        "<button class='btn btn-info btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-html='true' data-content='<strong>Creado por: </strong>" + data[i][4] + " <br /><strong>Fecha de creación:</strong> " + data[i][6] + "<br><strong>Modificado por:</strong>" + data[i][5] + "<br><strong>Fecha de modicación:</strong>" + data[i][7] + "'><i class='fas fa-info'></i></button> " +
                        (rolEditar == 1 ? "<button onclick='editarAlmacenFisico(\"" + data[i][3] + "\",\"" + data[i][0] + "\",\"" + data[i][1] + "\",\"" + data[i][2] + "\");'  class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button> " : " ") +
                        (data[i][8] == 1 && rolEliminar == 1 ? "<button onclick='bajaAlmacenFisico(" + data[i][1] + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-caret-down'></i></button>" : " ") +
                        (data[i][8] == 0 && rolEliminar == 1 ? "<button onclick='altaAlmacenFisico(" + data[i][1] + ")' class='btn btn-success btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Reactivar'><i class='fas fa-sort-up'></i></button>" : " ") +
                        (rolMapeo == 1 ? "<button onclick='abrirMapeo(" + data[i][1] + ")' class='btn btn-altima btn-circle btn-sm popoverxd' data-content='Mapeo' data-placement='top'><i class='fas fa-map' style='margin-left: -1px;'></i></button>" : " ") +
            ...
            if (rolAdmin == 1) {
                ...
                for (i in data) {
                    ...
                    a = [
                        ...
                        "<td style='text-align: center;'>" +
                        "<button class='btn btn-info btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-html='true' data-content='<strong>Creado por: </strong>" + data[i].creadoPor + " <br /><strong>Fecha de creación:</strong> " + data[i].fechaCreacion + "<br><strong>Modificado por:</strong>" + data[i].actualizadoPor + "<br><strong>Fecha de modicación:</strong>" + data[i].ultimaFechaModificacion + "'><i class='fas fa-info'></i></button> " +
                        (rolEditar == 1 ? "<button onclick='editMovimiento(\"" + data[i].idLookup + "\",\"" + data[i].nombreLookup + "\",\"" + data[i].tipoLookup + "\");'  class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button> " : " ") +
                        (data[i].estatus == 1 && rolEliminar == 1 ? "<button onclick='bajaMovimiento(" + data[i].idLookup + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-caret-down'></i></button>" : " ") +
                        (data[i].estatus == 0 && rolEliminar == 1 ? "<button onclick='altaMovimiento(" + data[i].idLookup + ")' class='btn btn-success btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Reactivar'><i class='fas fa-sort-up'></i></button>" : " ") +
            ...
            if (rolAdmin == 1) {
                ...
                $(data).each(function(i, v) { // indice, valor
                    tabla.row.add([
                        ...
                        v[3],
                        "<button class='btn btn-info btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-html='true' data-content='<strong>Creado por: </strong>" + v[5] + " <br /><strong>Fecha de creación:</strong> " + v[6] + "<br><strong>Modificado por:</strong>" + v[7] + "<br><strong>Fecha de modicación:</strong>" + v[8] + "'><i class='fas fa-info'></i></button> " +
                        (rolEditar == 1 ? "<button onclick='editarLinea(\"" + v[0] + "\",\"" + v[2] + "\",\"" + v[9] + "\");'  class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button> " : " ") +
                        (v[4] == 1 && rolEliminar == 1 ? "<button onclick='bajarlinea(" + v[0] + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-caret-down'></i></button>" : " ") +
                        (v[4] == 0 && rolEliminar == 1 ? "<button onclick='reactivarlinea(" + v[0] + ")' class='btn btn-success btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Reactivar'><i class='fas fa-sort-up'></i></button>" : " ")
