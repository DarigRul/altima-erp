            ...
            $(data).each(function(i, v){ // indice, valor
            	...
            	if (v.estatus == 1 ){
            		tabla.row.add([	
                		v.idText ,
                		v.nombreLookup ,
						'<button class="btn btn-primary btn-circle btn-sm popoverxd" onclick="verPrendasArreglo('+v.idLookup+')"  data-container="body" data-toggle="popover"  data-content="Prendas"><i class="fas fa-tshirt"></i></button>',
    					...
    					(rolEditar == 1 ? '<button class="btn btn-warning btn-circle btn-sm popoverxd" onclick="editarArreglo(this)" idLookup ="'+v.idLookup+'"  lookup="'+v.nombreLookup+'" descripcion="'+v.descripcionLookup+'" data-container="body" data-toggle="popover"  data-content="Editar"><i class="fas fa-pen"></i></button>': " ") +
