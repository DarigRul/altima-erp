...
$('.add-to-cart').click(function (event) {
  ...
  shoppingCart.addItemToCart(name, price, 1, value, idPedido, idPrenda, idTela, talla, nomTel);
  displayCart();
});
...
function displayCart() {
  ...
  for (var i in cartArray) {
    output += "<tr>"
      + "<td id='codigoBarras"+cartArray[i].idPedido+"'>" + cartArray[i].value.substring(0,3).toUpperCase()  + 
      										  cartArray[i].talla + 
      										  "TE"  + 
      										  (ceros + cartArray[i].idPedido).slice(-3)+"</td>" 
