...
public class AmpAlmacenLogicoServiceImpl implements IAmpAlmacenLogicoService {
	...
	public List<Object[]> findAllAMPLogico() {
		return em.createNativeQuery(
				"SELECT al.id_almacen_logico,al.nombre_almacen_logico,af.id_almacen_fisico,af.nombre_almacen,ampls.id_lookup as idsalida,ampls.nombre_lookup as salida\r\n"
	...
	public List<AmpAlmacenLogico> findAMPLogicoDuplicate(Long AlmacenFisico, String Nombre, Long Entrada, Long Salida) {
		return em.createQuery(
				"From AmpAlmacenLogico where idAlmacenFisico=" + AlmacenFisico + " and nombreAlmacenLogico='" + Nombre
						+ "' and idMovimientoEntrada=" + Entrada + " and idMovimientoSalida=" + Salida + " ")
				.getResultList();
	}
