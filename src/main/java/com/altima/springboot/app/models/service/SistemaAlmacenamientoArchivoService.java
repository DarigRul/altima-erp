...
public class SistemaAlmacenamientoArchivoService implements AlmacenamientoArchivoService  {
	private final Path rootLocation;

	@Autowired
	public SistemaAlmacenamientoArchivoService(PropiedadesAlmacenamientoService properties) {
